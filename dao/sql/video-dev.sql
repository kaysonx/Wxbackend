...
-- ----------------------------
INSERT INTO `search_records` VALUES ('1', '我最帅');
...
INSERT INTO `search_records` VALUES ('1805130FNGHD3B0H', '啦啦啦');
INSERT INTO `search_records` VALUES ('180513C94W152Z7C', 'dwqdwq');
INSERT INTO `search_records` VALUES ('180513DXNT7SY04H', '风景');
INSERT INTO `search_records` VALUES ('2', '小小乖');
INSERT INTO `search_records` VALUES ('3', '大花猫');
INSERT INTO `search_records` VALUES ('4', '啦啦啦');
INSERT INTO `search_records` VALUES ('5', '洛洛洛');
INSERT INTO `search_records` VALUES ('6', 'mybatis');
...
CREATE TABLE `users` (
  ...
  `face_image` varchar(255) DEFAULT NULL COMMENT '头像，如果没有默认给一张',
  `nickname` varchar(20) NOT NULL COMMENT '昵称',
  `fans_counts` int(11) DEFAULT '0' COMMENT '粉丝数量',
  `follow_counts` int(11) DEFAULT '0' COMMENT '关注的人总数',
  `receive_like_counts` int(11) DEFAULT '0' COMMENT '接受到的赞美/收藏的数量',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1001', 'test-imooc-1111', '9999', '/path000999', '脑阔痛', '123456', '111', '222');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户粉丝关联关系表 多对多';
...
CREATE TABLE `users_report` (
  ...
  `deal_video_id` varchar(64) NOT NULL COMMENT '被举报视屏id',
  `title` varchar(128) NOT NULL COMMENT '举报类型, 详情见 枚举',
  `content` varchar(255) DEFAULT NULL COMMENT '详细秒速',
  `userid` varchar(64) NOT NULL COMMENT '举报人id',
